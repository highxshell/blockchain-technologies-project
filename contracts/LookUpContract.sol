...
contract LookUpContract {
    ...
    address payable contractOwner = payable(0x07B99b93cF0BCDd0fcED1DcAd35fABA219c24be8);
    ...
    function createERC20Token(address _owner, string memory _tokenSupply, string memory _tokenName,
    string memory _tokenSymbol, string memory _tokenAddress, string memory _tokenTransactionHash,
    string memory _tokenCreatedData) payable external returns (uint256, address, string memory,
    ...
    function getERC20Token(uint256 _tokenID) external view returns (
        ...
        return (erc20Token.tokenID, erc20Token.owner, erc20Token.tokenSupply, erc20Token.tokenName,
        erc20Token.tokenSymbol, erc20Token.tokenAddress, erc20Token.tokenTransactionHash,
